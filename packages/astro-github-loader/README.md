...
[![npm version](https://img.shields.io/npm/v/@algorandfoundation/astro-github-loader?style=flat-square)](https://www.npmjs.com/package/@algorandfoundation/astro-github-loader)
...
```typescript
import { createOctokitFromEnv } from "@algorandfoundation/astro-github-loader";
...
```typescript
import { createAuthenticatedOctokit } from "@algorandfoundation/astro-github-loader";
...
```bash
npm install @algorandfoundation/astro-github-loader
```
